...
var paginationBar5 = {
    ...
    searchCountry: function (keepIndex) {
        ...
        paginationBar5.isSearchMode5 = true; // Enable search mode
            ...
            toolPaginationPages5.addItem(new sap.m.SegmentedButtonItem({
                ...
                press: function () {
                    if (paginationBar5.pagination5.index !== i) {
                        ...
                        paginationBar5.handleModePagination5(); // Fetch data for current mode
                        paginationBar5.updatePaginationUI5(); // Reflect UI changes
                    }
                }
            }));
        }
    ...
    executeFetch5: function () {
        ...
        const url = paginationBar5.isSearchMode5
            ? `http://localhost:8080/api/serverscript/cabserverside/CountrySearch`
            : `http://localhost:8080/api/serverscript/cabserverside/Country`;

        const data = paginationBar5.isSearchMode5
            ? { countryname: SearchField10.getValue(), take, skip }
            : { take, skip };
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response && Array.isArray(response.data)) {
                    modelTable4.setData(response.data); // Update table
                    ...
                    paginationBar5.updatePaginationUI5();
                } else {
